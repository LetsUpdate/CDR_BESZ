...
a gyrációs sugár jellemzi az egyének által bejárt területet \cite{gonzalez2008understanding}.
...
metrikák számítási módszereit, különös tekintettel a gyrációs sugárra és az
...
\begin{itemize}
	...
	\item A mobilitási metrikák számítását végző modulok fejlesztése, beleértve a
		gyrációs sugár, a térbeli és időbeli entrópia, a home–work távolság és
	...
	\item Esettanulmányok készítése: például a város különböző kerületeinek
		összehasonlítása a gyrációs sugár vagy az entrópia alapján, ingázási hálózatok
