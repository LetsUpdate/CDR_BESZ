...
4. \textbf{Analitikai réteg és metrikaszámítás:} A feldolgozott adatokból aggregált statisztikákat és mobilitási mutatókat számolunk (például mozgástér sugara, entrópia, home–work távolság) \cite{pinter2020artificial, pinter2021evaluating}. A skálázhatóság miatt a modern rendszerek gyakran Spark keretrendszert alkalmaznak, hogy párhuzamosan dolgozhassanak \cite{zhang2019connected}.
