...
A leképezés indoklása: a 85 finom kategória statisztikai elemzéshez túl részletes (sok kategóriában csak néhány cella esik), ezért a CDR-szakirodalomban szokásos területhasználati zónákra (\textit{land-use zones}) aggregáljuk. A \texttt{transit} és \texttt{parking} ezért külön zóna, hogy a közlekedési csomópontok aktivitásmintázata izolálható maradjon.
