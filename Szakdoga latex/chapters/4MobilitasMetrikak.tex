...
\subsection{Radius of Gyration (mozgástér sugara)}

A mozgástér sugara ($r_{g}$) az egyéni mobilitás hatótávolságának alapvető mérőszáma,
...
Ekkor a mozgástér sugara definíciója:
...
\begin{figure}[h!]
	...
	\caption[A mozgástér sugara (Radius of Gyration) szemléltetése]{A mozgástér sugara ($r_g$) szemléltetése. \\ \footnotesize\textit{Forrás: AI generált kép}}
...
A mozgástér sugara, az entrópia és a helydiverzitás mellett a megvalósított rendszer (7.\ fejezet) további napi metrikákat is számít:
