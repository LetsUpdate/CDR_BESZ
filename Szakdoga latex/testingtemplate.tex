...
\titleformat{\section}{\normalfont\fontsize{14}{16}\bfseries\centering\MakeUppercase} {\thesection}{1em}{}
...
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead{}        % fejléc törlése
\fancyfoot{}        % lábléc törlése
\fancyhead[C]{\thepage}   % oldalszám felül középen
\renewcommand{\headrulewidth}{0pt}
\setlength{\headheight}{14pt}
\setlength{\headsep}{20mm} % 20mm a lapszéltől
\makeatother